module.exports = (() => {
  ...
  class CommandLineInterface {
    ...
    run(args, callback) {
      ...
      if (!command) {
        return callback(new Error(`Command "${this.format(args.commandName, args.subName)}" does not exist.`));
      }

      return command.run(args.args, args.flags, args.vflags, callback);
